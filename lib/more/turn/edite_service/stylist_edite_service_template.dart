...
class STYLIST_EDITE_SERVICE_TEMPLATE extends StatefulWidget {
  ...
  STYLIST_EDITE_SERVICE_TEMPLATE(
    this.nameService,
    this.price,
    this.floating,
    this.offPrice,
  ...
  @override
  State<STYLIST_EDITE_SERVICE_TEMPLATE> createState() =>
      _STYLIST_EDITE_SERVICE_TEMPLATEState();
}

class _STYLIST_EDITE_SERVICE_TEMPLATEState
    extends State<STYLIST_EDITE_SERVICE_TEMPLATE> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: InkWell(
        ...
        onTap: () {
          barberData.addServiceInEditeMode({
            "id": widget.id,
        ...
        onLongPress: () {
          barberData.removeServiceInEditeMode(widget.id);
        },
        child: Card(
                  ...
                  SizedBox(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 12,
                        color:
                            widget.quantity > 0 ? Colors.white : Colors.black54,
                      ),
                    ),
                  ),
                  widget.material["has"]
