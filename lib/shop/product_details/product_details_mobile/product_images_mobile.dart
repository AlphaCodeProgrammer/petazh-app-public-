...
class PRODUCT_IMAGES_MOBILE extends StatefulWidget {
  @override
  State<PRODUCT_IMAGES_MOBILE> createState() => _PRODUCT_IMAGES_MOBILEState();
}

class _PRODUCT_IMAGES_MOBILEState extends State<PRODUCT_IMAGES_MOBILE> {
  String mainImage = "";
